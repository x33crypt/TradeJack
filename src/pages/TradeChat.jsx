    ...
    <>
      ...
      <div className=" lg:pt-[80px] md:pt-[85px] pt-[67px] flex gap-[15px] min-h-screen bg-black lg:p-[2%] md:p-[2.5%] ">
        ...
        <div className="flex-1 flex justify-between flex-col md:border border-tradeAshLight md:rounded-[10px]">
          ...
          <div className="bg- px-[15px] h-full overflow-y-auto">
            hello
          </div>
          <div className="flex items-center gap-[10px] p-[15px]">
            <div className="p-[6px] rounded-full bg-white text-[18px] text-black">
              <IoAttach />
            </div>
            <div className="flex-1 flex gap-[20px] bg-tradeAsh border border-tradeAshExtraLight p-[6px] rounded-[10px]">
              <input
                className="w-full outline-none px-[2px]  py-[2px] text-[14px] text-white placeholder:text-tradeFadeWhite bg-tradeAsh"
                type="text"
