...
const CreateOfferSummary = () => {
  ...
  return (
    <>
      <InAppNav />
      <div className="flex lg:flex-row flex-col min-h-svh bg-black lg:px-[15%] md:px-[2.5%] px-[15px] md:pt-[64px] pt-[60px]">
        <div className=" relative w-full gap-[15px] md:gap-0 flex flex-col md:border-x md:border-b md:border-t-0 border-neutral-800">
          <div className="flex flex-col justify-between md:p-[15px] py-[15px] border-b border-tradeAshLight w-full">
          ...
          <div className="flex flex-col md:p-[15px]">
            ...
            <div className="flex flex-col gap-3 p-[15px] bg-tradeAsh border border-t-0 border-tradeAshLight">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-tradeFadeWhite text-sm">
                  ...
                  the payment is not made within this timeframe, the trade will
                  be automatically canceled. If funds were sent but not
          ...
          <div className=" bg-black flex flex-col gap-[15px] py-[15px] md:p-[15px]">
