        ...
        <div className="flex-1 flex flex-col md:flex-row gap-[5px]">
          ...
          <div className="flex flex-col flex-1 md:border border-neutral-800 min-h-svh">
            <div className="flex  items-center justify-between px-[15px] py-[12px] border-b border-tradeAshLight">
              <p className="text-lg font-[700] text-white ">KYC Information</p>
            </div>
                    ...
                    <div className="w-full h-full">
                      {status?.state === "not_submitted" ? (
                        <div className="h-full flex flex-col p-[15px] gap-[25px]">
                          <div className="">
                            <p className="text-xs text-tradeFadeWhite font-medium">
                              ...
                              full access to all features. Get verified in just
                              a few steps.
                            </p>
                          </div>
                        ...
                        <div className="h-full flex flex-col p-[15px] gap-[25px]">
                          <div className="">
                            <p className="text-xs text-tradeFadeWhite font-medium">
                              Your details have been submitted and are currently
                              under review. While updates aren’t allowed during
                              this process, you’ll be able to resubmit if your
