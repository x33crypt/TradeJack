...
const MessageSideNav = () => {
  ...
  return (
    <div className="lg:flex flex-col hidden w-[300px] max-h-svh pt-[60px] gap-[5px] ">
      ...
      <div className="py-[10px] pr-[15px] flex flex-col gap-[30px] overflow-auto custom-scrollbar">
