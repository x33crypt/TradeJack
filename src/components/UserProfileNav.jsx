...
const UserProfileNav = () => {
  ...
  return (
    <div className="lg:flex hidden rounded-[14px] p-[10px] border border-tradeAshLight w-[260px] max-h-max gap-[30px] flex-col">
      <div className="flex flex-col gap-[30px] pt-[5px] bg-tradeOrang">
        <div className="flex items-center gap-[15px]">
          ...
          <div>
            <p className="text-white lg:text-[19px] sm:text-[38px] text-[25px] font-extrabold">
              0xSanityy
            </p>
