      ...
      <div className="lg:p-[80px] md:p-[50px] p-[20px] flex flex-col gap-[40px]">
        <div className="flex flex-col gap-[20px]">
          <div className="lg:hidden flex items-center justify-center gap-[8px] mt-[20px] ">
            <GiCardExchange className=" flex lg:text-[19px] md:text-[19px] text-[23px] text-tradeGreen" />
            <p className=" lg:text-[19px] md:text-[22px] text-[23px] font-[700] text-tradeGreen">
              Trade
              <small className="lg:text-[19px] md:text-[19px] text-[23px] font-[700] text-white">
                Jack
              </small>
            </p>
          </div>
