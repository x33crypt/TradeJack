    ...
    <div className="lg:w-[600px] w-full bg-black pb-[30px] ">
      <div className="lg:p-[80px] md:p-[50px] p-[20px] flex flex-col gap-[50px]">
        <div className="flex flex-col items-center gap-[5px]">
          <div className="lg:hidden flex items-center justify-center my-[30px] gap-[10px] ">
            <GiCardExchange className=" flex lg:text-[19px] md:text-[19px] text-[20px] text-tradeGreen" />
            <p className=" lg:text-[19px] md:text-[22px] text-[20px] font-[700] text-tradeGreen">
              Trade
              <small className="lg:text-[19px] md:text-[19px] text-[20px] font-[700] text-white">
                Jack
              </small>
            </p>
          </div>
        ...
        <div className="flex flex-col gap-[30px]">
          <div className="flex flex-col gap-[30px]">
            <div className=" flex items-center w-full gap-[10px] justify-center text-white border-[1px] border-tradeAshLight p-[12px] rounded-[10px] cursor-pointer">
          ...
          <div className="mt-[15px] flex flex-col items-center gap-[30px]">
            ...
            <p className="text-tradeFadeWhite text-[13px] font-[500]">
              ...
              <small className="text-[13px] text-white font-[700]">
                Log in
              </small>
            </p>
          </div>
