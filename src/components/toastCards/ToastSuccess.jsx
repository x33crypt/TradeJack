    ...
    >
      {toast.success && (
        <div
          ...
          className="flex items-center gap-3 bg-black border border-tradeGreen p-4 rounded-[10px] shadow-md lg:max-w-[400px] md:max-w-[50%] max-w-full min-w-[300px] toast-animate-fadeInOut cursor-pointer pointer-events-auto"
        >
