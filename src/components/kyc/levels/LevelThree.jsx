    ...
    <div className="flex flex-col gap-[30px]">
      ...
      <div className=" flex flex-col bg-tradeOrange border border-tradeAshLight rounded-[15px] p-[10px] gap-[15px]">
        ...
        <div className="flex justify-between gap-[10px] pt-[5px]">
          ...
          <div
            onClick={() => setShowThreeDetails(!showThreeDetails)}
            className={`${
              showThreeDetails ? "rotate-180" : ""
        ...
        >
          <div className="flex flex-col gap-[10px]">
            <div className="flex justify-between">
              <p className="text-xs text-black font-semibold">Face Photo</p>
              <div className="flex items-center gap-1">
                <p className="text-xs text-black font-semibold">View</p>
                <MdOutlineKeyboardArrowRight className="text-lg" />
              </div>
            </div>
            <div className="flex justify-between">
              <p className="text-xs text-black font-semibold">Address Photo</p>
              <div className="flex items-center gap-1">
                <p className="text-xs text-black font-semibold">View</p>
                <MdOutlineKeyboardArrowRight className="text-lg" />
              </div>
      ...
      <div className=" flex flex-col bg-tradeAshLight border border-tradeAshLight rounded-[15px] p-[10px] gap-[15px]">
        ...
        >
          <div className="flex flex-col gap-[10px]">
            <div className="flex justify-between">
              <p className="text-xs text-white font-semibold">NIN</p>
              <p className="text-xs text-white font-semibold">**** *** 0000</p>
            </div>
            <div className="flex justify-between">
              <p className="text-xs text-white font-semibold">BVN</p>
              <p className="text-xs text-white font-semibold">**** *** 0000</p>
            </div>
          </div>
        </div>
