  ...
  return (
    <div className="flex flex-col gap-[30px]">
      ...
      <div className=" flex flex-col bg-tradeOrange border border-tradeAshLight rounded-[15px] p-[10px] gap-[15px]">
        ...
        <div
          className={`${
            showDetails ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0 mt-0"
          }  transition-[max-height, opacity, margin-top] ease-in-out duration-700 overflow-hidden pb-[5px]`}
        >
          <div className="flex flex-col gap-[10px]">
            <div className="flex justify-between">
              <p className="text-xs text-black font-semibold">Full Name</p>
              <p className="text-xs text-black font-semibold">
                LUKMAN ADEKUNLE ADELEKE
              </p>
            </div>
            <div className="flex justify-between">
              <p className="text-xs text-black font-semibold">Gender</p>
              <p className="text-xs text-black font-semibold">Male</p>
            </div>
            <div className="flex justify-between">
              <p className="text-xs text-black font-semibold">Date of Birth</p>
              <p className="text-xs text-black font-semibold">Feb **,**</p>
            </div>
            <div className="flex justify-between">
              <p className="text-xs text-black font-semibold">Phone Number</p>
              <p className="text-xs text-black font-semibold">08039921211</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <Button variant="secondary" onClick={() => navigateTo("/kyc/tier/2")}>
        UPGRADE LEVEL
      </Button>
    </div>
  );
