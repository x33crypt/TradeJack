  ...
  return (
    <div className="z-50 px-[5%] bg-[rgb(17,17,22)] lg:h-[100px] h-[90px] flex items-center justify-between fixed top-0 right-0 left-0">
      ...
      <div className="flex items-center gap-[20px]">
        <div className="flex items-center gap-[10px] text-black hover:text-white border border-tradeGreen bg-tradeGreen hover:bg-transparent lg:px-[25px] px-[15px] py-[9px] rounded-[8px] transition-all duration-300 cursor-pointer">
