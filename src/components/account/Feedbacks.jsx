...
const Feedbacks = () => {
  ...
  return (
    <div className=" flex gap-[5px] bg-black w-full">
            ...
            <div className="flex flex-1">
              {profile === null ? (
                ...
                <div className="flex flex-col flex-1 ">
                  ...
                  <div className="custom-x-scrollbar flex py-[12px] px-[15px] h-max gap-[5px] justify-between w-full items-center overflow-x-auto border-t border-dashed border-tradeAshLight">
